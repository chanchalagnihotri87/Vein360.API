...
namespace Vein360.Persistence
{
    public class Vein360Context : DbContext
    {
        ...
        public DbSet<Vein360ContainerType> Vien360ContainerTypes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Vein360ContainerType>().HasData(
                new Vein360ContainerType { Id = 1, Name = "Large Container", Capacity = 10, CreatedDate = new DateTime(2025, 4, 16) },
                new Vein360ContainerType { Id = 2, Name = "Medium Container", Capacity = 7, CreatedDate = new DateTime(2025, 4, 16) },
                new Vein360ContainerType { Id = 3, Name = "Small Container", Capacity = 3, CreatedDate = new DateTime(2025, 4, 16) },
                new Vein360ContainerType { Id = 4, Name = "Extra Large Container", Capacity = 15, CreatedDate = new DateTime(2025, 4, 16) });
            ...
            modelBuilder.Entity<Vein360Container>().HasData(
                ...
                new Vein360Container { Id = 4, ContainerTypeId = 4, ContainerCode = "CNT100004", Status = Vein360ContainerStatus.Available, CreatedDate = new DateTime(2025, 4, 16) },
                ...
                new Vein360Container { Id = 8, ContainerTypeId = 4, ContainerCode = "CNT100008", Status = Vein360ContainerStatus.Assigned, CreatedDate = new DateTime(2025, 4, 16) },
                ...
                new Vein360Container { Id = 16, ContainerTypeId = 4, ContainerCode = "CNT100016", Status = Vein360ContainerStatus.Available, CreatedDate = new DateTime(2025, 4, 16) });
            ...
            modelBuilder.Entity<DonationContainer>().HasData(
                ...
                new DonationContainer { Id = 3, ContainerTypeId = 3, ContainerId = 3, Status = DonationContainerStatus.Dispatched, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), TrackingNumber = 794971829663 },
                new DonationContainer { Id = 4, ContainerTypeId = 4, ContainerId = 4, Status = DonationContainerStatus.Donated, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), TrackingNumber = 794971829663 },
                ...
                new DonationContainer { Id = 8, ContainerTypeId = 4, ContainerId = 8, Status = DonationContainerStatus.Filled, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), TrackingNumber = 794971829663 },
                new DonationContainer { Id = 9, ContainerTypeId = 1, ContainerId = 9, Status = DonationContainerStatus.Received, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), TrackingNumber = 794971829663 },
                new DonationContainer { Id = 10, ContainerTypeId = 2, ContainerId = 10, Status = DonationContainerStatus.Received, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), TrackingNumber = 794971829663 },
                new DonationContainer { Id = 11, ContainerTypeId = 3, ContainerId = 11, Status = DonationContainerStatus.Received, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), TrackingNumber = 794971829663 },
                new DonationContainer { Id = 12, ContainerTypeId = 1, ContainerId = 12, Status = DonationContainerStatus.Received, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), TrackingNumber = 794971829663 });

            modelBuilder.Entity<Donation>().HasData(
                new Donation { Id = 1, ContainerType = ContainerType.Vien360Container, DonationContainerId = 4, TrackingNumber = 1234567890, LabelFileName = "label.pdf", Status = DonationStatus.Dispatched, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), Weight = 10, Products = [] },
                new Donation { Id = 2, ContainerType = ContainerType.Vien360Container, DonationContainerId = 9, TrackingNumber = 1234567891, LabelFileName = "label.pdf", Status = DonationStatus.Received, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), Weight = 20, Products = [] },
                new Donation { Id = 3, ContainerType = ContainerType.Vien360Container, DonationContainerId = 10, TrackingNumber = 1234567891, LabelFileName = "label.pdf", Status = DonationStatus.Verified, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), Weight = 30, Products = [] },
                new Donation { Id = 4, ContainerType = ContainerType.Vien360Container, DonationContainerId = 11, TrackingNumber = 1234567891, LabelFileName = "label.pdf", Status = DonationStatus.Paid, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), Weight = 40, Products = [] },
                new Donation { Id = 5, ContainerType = ContainerType.Vien360Container, DonationContainerId = 8, TrackingNumber = 1234567891, LabelFileName = "label.pdf", Status = DonationStatus.Pending, DonorId = Constants.UserId, CreatedDate = new DateTime(2025, 4, 16), Weight = 50, Products = [] });
