...
namespace Vein360.Application.Repository
{
    public interface IBaseRepository<T> where T : BaseEntity
    {
        ...
        IQueryable<T> GetManyAsQueryableNoTracking(Expression<Func<T, bool>> predicate);
        IQueryable<T> GetManyAsQueryableNoTracking(Expression<Func<T, bool>> predicate, params Expression<Func<IQueryable<T>, IIncludableQueryable<T, object>>>[] includes);
