...
namespace Vein360.Application.Common.Helpers.Encryption
{
    public class EncryptionHelper
    {
        ...
        {
            Encrypter helper = new Encrypter();
    ...
    class Encrypter
    {
        ...
        {
            return ByteArrToString(EncryptByte(TextValue));
        }

        /// Encrypt some text and return an encrypted byte array.
        public byte[] EncryptByte(string TextValue)
        {
        ...
        public string Decrypt(string EncryptedString)
        {
            try
            {
                return DecryptByte(StrToByteArray(EncryptedString));
            }
            catch
            {
                return string.Empty;
        ...
        public string DecryptByte(byte[] EncryptedValue)
        {
    ...
    {
        private static byte[] salt = new byte[] { 122, 35, 183, 45, 28, 63, 57, 174, 191, 8 };

        public static string EncryptPassword(string password)
        {
            byte[] passwordBytes = new byte[Encoding.UTF8.GetByteCount(password) + salt.Length];
        ...
        public static void IsEncrypted(string encryptedPassword)
        {
            ToBase64Transform asfsa = new ToBase64Transform();
        }
    }
}
